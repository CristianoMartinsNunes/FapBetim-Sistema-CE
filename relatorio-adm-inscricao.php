<?php
    ...
    $listaEvento = select_Cevento_Rel($conexao,$_POST["evento"]);
    $listaInscricao = select_Cinscricao_Rel($conexao,$_POST["evento"]);
	...
	$pdf->ln();
	$pdf->ln();
	$pdf->Cell(193, 6,'Data\Hora Emissão: '.$datehora,0,0,"L");
